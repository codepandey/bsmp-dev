          ...
          <div className="row">
            <div className="col col-lg-3 col-md-6 col-sm-12 col-12">
              <div className="widget about-widget">
                ...
                <p>
                  We Offer The Freshes Farm-To-Table Products Delivered Straight
                  To Your Door.
                </p>
                <ul>
            ...
            <div className="col col-lg-3 col-md-6 col-sm-12 col-12">
              <div className="widget tp-service-link-widget">
                ...
                <div className="contact-ft">
                  <ul>
                    <li>
                      <i className="fi flaticon-pin"></i>Brahamshakti milk
                      products, Gokul colony, Near Sunarian chowk, Rohtak,
                      124001
                    </li>
                    <li>
          ...
          <div className="row">
            <div className="col col-xs-12">
              <p className="copyright">
                {" "}
                Copyright &copy; 2022 Brahamshakti by{" "}
                <Link onClick={ClickHandler} to="/">
                  Condigence
                </Link>
                . All Rights Reserved.
