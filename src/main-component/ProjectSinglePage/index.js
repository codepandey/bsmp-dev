            ...
            <div className="col col-lg-8 col-12">
              <div className="project-content">
                ...
                <div className="pagi">
                  <ul>
                    <li>
                      <Link to="/project-single">Previous</Link>
                    </li>
                    <li>
                      <Link to="/project-single">Next</Link>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="col col-lg-4 col-12">
              <div className="service-sidebar">
                <div className="widget project-info-widget">
                  ...
                  <ul>
                    <li>
                      <span>Project Title: </span> FRESH ORIGINAL HONEY{" "}
                    </li>
                    <li>
                      <span>Client: </span> Robert Symon
                    </li>
                    <li>
                      <span>Date: </span> 20 January 2021
                    </li>
                    <li>
                      <span>Project Value:</span> ₹5500
                    </li>
                    <li>
                      <span>Category: </span> Honey{" "}
                    </li>
                    <li>
                    ...
                    <li>
                      <span>live link : </span>{" "}
                      <Link to="/project-single">http://demo.com</Link>{" "}
                    </li>
                  </ul>
                </div>
              </div>
